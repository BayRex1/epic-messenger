...
class PostsHandler {
    ...
    handleLikeComment(token, data) {
        ...
        try {
            ...
            this.dataManager.saveData();
            this.securitySystem.logSecurityEvent(user, 'LIKE_COMMENT', `post:${postId}, comment:${commentId}, action:${liked ? 'like' : 'unlike'}`);
    ...
    handleLikeReply(token, data) {
        ...
        try {
            ...
            this.dataManager.saveData();
            this.securitySystem.logSecurityEvent(user, 'LIKE_REPLY', `post:${postId}, comment:${commentId}, reply:${replyId}, action:${liked ? 'like' : 'unlike'}`);
